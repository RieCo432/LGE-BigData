...
# class_list = ["1B latine", "1B", "1C1", "1C2 latine", "1C2", "1D", "1E(F)", "1(E)F", "1D(G)", "1(D)G latine", "1(D)G",
#              "1G", "2A", "2A", "2A", "2B(C) latine", "2B(C)", "2(B)C", "2C latine", "2C", "2D(G)", "2(D)G", "2D(F)",
#              "2(D)F", "2E latine", "2E", "2G", "2G", "3B(C) latine", "3B(C)", "3(B)C latine", "3(B)C", "3C latine",
#              "3C", "3D latine", "3D", "3D(G)", "3(D)G", "3E(F) latine", "3E(F)", "3E(F) latine", "3(E)F",
#              "3E(G) latine", "3E(G)", "3(E)G", "IV.1", "41", "IV.2", "42", "43", "44", "45", "V.1", "51", "52", "53",
#              "54", "VI 1", "61", "62", "63", "64", "65", "71", "72", "73", "74", "75", "76", "CLIJA+", "1ère,2e", "2e",
...
for h in range(1, 71 + 1):
    ...
    if True:
        ...
        detected_class = tree.xpath("/html/body/center/font[2]/b")[0].text.strip()
        print(str(detected_class))
        class_list.append(detected_class)

        for i in range(2, 17, 2):  # cycle through times
            for j in range(2, 7):  # cycle through days

                subject = tree.xpath(
                    "/html/body/center/table[1]/tbody/tr[" + str(i) + "]/td[" + str(
                        j) + "]/table/tbody/tr/td[1]/font/b")
                teacher = tree.xpath(
                    "/html/body/center/table[1]/tbody/tr[" + str(i) + "]/td[" + str(
                        j) + "]/table/tbody/tr/td[2]/font/b")
                room = tree.xpath(
                    "/html/body/center/table[1]/tbody/tr[" + str(i) + "]/td[" + str(
                        j) + "]/table/tbody/tr/td[3]/font/b")
...
with open("class_list.txt", "w") as fout:
    fout.write(str(class_list))
